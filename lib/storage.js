...
Storage.prototype.lastPaymentDoc = function (channelId, callback) {
    var self = this;
    var query = { kind: this.kind('payment'), channelId: channelId };
...
Storage.prototype.saveChannel = function (paymentChannel, callback) {
    ...
    var query = { channelId: paymentChannel.channelId, kind: this.kind("channel") };
 ...
 * @returns {string}
 */
Storage.prototype.kind = function (raw) {
    if (this.namespace) {
