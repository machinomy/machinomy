...
const CONTRACTS = {
    ropsten: "0xa39316bd6c138c0865b18713d09805fd5201e36c",
    homestead: null
};
...
const CONTRACT_INTERFACE = [{
    ...
    "constant": false,
    "inputs": [{"name": "channelId", "type": "bytes32"}, {"name": "payment", "type": "uint256"}, {
        "name": "v",
        "type": "uint8"
    ...
    "constant": true,
    "inputs": [{"name": "channelId", "type": "bytes32"}, {"name": "value", "type": "uint256"}],
    "name": "getHash",
    ...
    "constant": true,
    "inputs": [{"name": "sender", "type": "address"}, {"name": "channelId", "type": "bytes32"}],
    ...
    "inputs": [{"indexed": true, "name": "sender", "type": "address"}, {
        ...
        "name": "receiver",
        "type": "address"
    }, {"indexed": false, "name": "channelId", "type": "bytes32"}],
    ...
    "inputs": [{"indexed": true, "name": "channelId", "type": "bytes32"}, {
        ...
        "name": "payment",
        "type": "uint256"
    }, {"indexed": false, "name": "oddValue", "type": "uint256"}],
    "name": "DidSettle",
    "type": "event"
}];
