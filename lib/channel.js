...
const buildPaymentChannel = (contract, sender, receiver, value, callback) => {
  ...
  var didCreateChannelEvent = contract.DidCreateChannel({sender: sender, receiver: receiver})
  ...
  didCreateChannelEvent.watch(function (error, result) {
    ...
    var paymentChannel = new PaymentChannel(sender, receiver, channelId, value, 0)
 ...
 * @param callback
 */
ChannelContract.prototype.buildPaymentChannel = (sender, receiver, value, callback) => {
  buildPaymentChannel(this.contract, sender, receiver, value, callback)
}
