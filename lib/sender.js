...
class Sender {
  ...
  freshChannel (uri, paymentRequired, value) {
    return this.contract._buildPaymentChannel(this.account, paymentRequired.receiver, value).then(paymentChannel => {
      ...
      return this.storage.channels.saveOrUpdate(paymentChannel).then(() => {
        ...
        return this.storage.channels.saveOrUpdate(nextPaymentChannel)
      }).then(() => {
